...
from Wav_Denoiser.audio_denoiser.helpers.torch_helper import batched_apply
from Wav_Denoiser.audio_denoiser.modules.AudioNoiseModel import AudioNoiseModel, load_audio_denoiser_model
from Wav_Denoiser.audio_denoiser.helpers.audio_helper import create_spectrogram, reconstruct_from_spectrogram

_expected_t_std = 0.23


class AudioDenoiser:
    def __init__(self, model_name='jose-h-solorzano/Wav_Denoiser-512-32-v1',
        ...
        self.device = device
        # self.model = AudioNoiseModel.from_pretrained(model_name)
        self.model = load_audio_denoiser_model(model_name, device)
        self.model.eval()
