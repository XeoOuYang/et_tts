...
def execute_asr(input_folder, output_folder, model_size, language, precision, extens=[]):
    ...
    if len(extens) > 0:
        input_file_names = [file_name for file_name in input_file_names
                            if os.path.splitext(os.path.dirname(file_name))[1] in extens]
